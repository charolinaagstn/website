          ...
          >
            ...
            <div className="p-6">
              ...
              <motion.button
                ...
                onClick={() => window.location.href = `/form-pemesanan?tema=${item.title}&harga=${item.price}`}
                className="px-5 py-2 bg-gradient-to-r from-sky-500 to-blue-600 text-white rounded-full shadow-md font-medium transition"
              >
                Pesan Sekarang - {item.price}
              </motion.button>
